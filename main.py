...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'shubhsoli114@gmail.com' ")
...
def send_email():
    ...
    from_email = "shubhsoli114@gmail.com"  # Update with your email
    password = "ppid xlra nmxs jdgx"  # Update with your email password
